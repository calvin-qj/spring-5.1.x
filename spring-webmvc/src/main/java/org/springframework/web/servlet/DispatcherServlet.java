	...
	protected void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			try {
				...
				// Determine handler adapter for the current request. 获取处理请求的处理器适配器HandlerAdapter
				HandlerAdapter ha = getHandlerAdapter(mappedHandler.getHandler());

				// Process last-modified header, if supported by the handler. 处理last-modified请求头
				...
				// Actually invoke the handler. 实际处理器处理请求，返回结果试图对象
